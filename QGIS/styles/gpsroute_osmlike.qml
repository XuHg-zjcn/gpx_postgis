                ...
                <Option type="Map">
                  ...
                  <Option type="Map" name="properties">
                    <Option type="Map" name="outlineColor">
                      ...
                      <Option value="color_hsv((450-azimuth(&#xa;point_n($geometry,@geometry_part_num*2-2),&#xa;point_n($geometry,@geometry_part_num*2))/pi()*180)%360,&#xa;100, 100)" type="QString" name="expression"/>
